...
Do not edit or delete legacy documentation

Do not migrate entire documents

Do not preserve narrative, history, or motivation prose

One file = one claim

If unsure, discard the statement

Never summarize

Never create overview files
...
Read the legacy Markdown document

Identify extractable statements using the criteria above

Classify each statement into a single atom type

Create one atom per statement

Write the atom with minimal wording

Add limited relationships if obvious

Stop when no more safe extractions exist
